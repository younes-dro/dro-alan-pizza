...
if ($creme_fraiche->have_posts()) {
//    $terms = get_the_terms(get_the_ID(),'type_pizza');
//    print_r($terms);
    ?>
    <div class="row">
        <div class="page-header"><h1><span class="red">Creme fraiche </span></h1></div>
        <?php
        while ($creme_fraiche->have_posts()) {
            ?>
            <div class="col-xs-12 col-sm-6 col-md-4 element-pizza" >
                <?php
                $creme_fraiche->the_post();
